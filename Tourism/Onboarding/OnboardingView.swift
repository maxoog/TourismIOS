        ...
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 24) {
                if state == .travel {
                    ...
                    image(name: "open")
                    header(text: "Бронируй жильё", description: "Отслеживай в реальном времени бронирования во вкладке “Мои бронирования” и получай push-уведомление о смене его статуса")
